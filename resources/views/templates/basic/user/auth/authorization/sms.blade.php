                ...
                <div class="verification-code-wrapper">
                    <div class="verification-area">
                        <div class="d-flex justify-content-between gap-2 flex-wrap border-bottom mb-3">
                            <h5 class="text-center ">@lang('Verify Mobile Number')</h5>
                        ...
                        <form action="{{ route('user.verify.mobile') }}" method="POST" class="submit-form">
                            ...
                            <div class="form-group">
                                <p>
                                    @lang('If you don\'t get any code'), <span class="countdown-wrapper">@lang('try again after') <span id="countdown" class="fw-bold">--</span>
                                        @lang('seconds')</span> <a href="{{ route('user.send.verify.code', 'sms') }}" class="try-again-link d-none">
                                        @lang('Try again')</a>
                                    </p>
                            </div>
                        </form>
