...
@section('panel')
    <form action="{{ route('admin.currencies.update', @$currency->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input id="txt_name" class="form-control" name="currency" required type="text" value="{{ old('currency', @$currency->currency) }}">
                                </div>

                                <div class="form-group">
                                    <label for="txt_symbol">@lang('Symbol')</label>
                                    <input id="txt_symbol" class="form-control" name="symbol" required type="text" value="{{ old('symbol', @$currency->symbol) }}">
                                </div>
