                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">{{ __(gs('cur_text')) }} @lang('Request')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can request to platform for ') {{ __(gs('cur_text')) }}</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="request_for_coin" @if (gs('request_for_coin')) checked @endif>
                                </div>
                            </li>
