...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('chart/ticket-sold', 'ticketSoldReport')->name('chart.ticket.sold');
    ...
    Route::controller('LotteryController')->name('lottery.')->prefix('lottery')->group(function () {
        ...
        Route::get('winning/setting/{id}', 'winningSetting')->name('winning.setting');
        Route::post('winning/setting/store/{id}', 'winningSettingStore')->name('winning.setting.store');

        Route::get('multi-draw/setting/{id}', 'multiDrawSetting')->name('multi.draw.setting');
        Route::post('multi-draw/setting/{id}', 'multiDrawSettingStore')->name('multi.draw.setting.store');
        Route::post('multi-draw/option/update/{id}', 'updateMultiDrawOption')->name('multi.draw.option.update');
        Route::post('multi-draw/option/status/{id}', 'updateMultiDrawStatus')->name('multi.draw.option.status');
    ...
    Route::controller('CoinRequestController')->prefix('coin/request')->name('coin.request.')->group(function () {
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('ticket/purchase/history', 'ticketPurchaseHistory')->name('ticket.purchase.history');
        Route::get('lottery/winning-history', 'winningHistory')->name('winning.history');
        Route::get('lottery/winning/details/{id}', 'winningDetail')->name('winning.detail');
    });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::get('coin-instruction', 'coinInstruction')->name('setting.coin.instruction');
        Route::post('coin-instruction-update', 'coinInstructionUpdate')->name('setting.coin.instruction.update');
